...
class CustomTabBarView: UIView {
    ...
    // creates a thin divider at the top of the bar
    func setUpDividerBar(){
        let lightGrayColorPT = UIColor(hue: 0, saturation: 0, brightness: 0.85, alpha: 1.0) /* #d9d9d9 */

        let view = UIView()
        view.backgroundColor = lightGrayColorPT
        addSubview(view)
...
private class CustomTabView: UIView{
   ...
   // Layout
    private func setUpView(item: CustomTabItem){
        ...
        itemIconView.tintColor = lightGrayColorPT
